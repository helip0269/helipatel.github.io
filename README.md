...
<body class="main-content">
    ...
    <main>
                ...
                <div class="right-about">
                    ...
                    <div class="about-item">
                        <div class="abt-text">
                            ...
                            <p class="small-text">Experience <br /> Completed</p>
                        </div>
                    </div>
                    <div class="about-item">
                        <div class="abt-text">
                            <p class="large-text">00</p>
                            <p class="small-text">Happy clients <br /> Completed</p>
                        </div>
                    </div>
                    <div class="about-item">
                        <div class="abt-text">
                            <p class="large-text">00</p>
                            <p class="small-text">Cutomer reviews <br /> Completed</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section sec4 newspaper" id="newsletter">
            <h2>NEWS UPDATES</h2>
            <rssapp-magazine id="Oreo1HkwxzTvWR3g"></rssapp-magazine><script src="https://widget.rss.app/v1/magazine.js" type="text/javascript" async></script>
        </section>
        <section class="section sec5 contacts" id="contacts">
                        ...
                        <form action="" class="contact-form">
                            ...
                            <div class="submit-btn">
                                <a href="#" class="main-btn">
                                    ...
                                    <span class="btn-icon"><i class="fas fa-submit"></i></span>
                                </a>
                            </div>
                        </form>
                    </div>
    ...
    <div class="controlls">
        ...
        <div class="control control-4 " data-id="newsletter">
